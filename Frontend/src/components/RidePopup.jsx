...
const RidePopup = ({ setRidePopup, ridePopup, setConfirmRidePopup}) => {
  return (
    <div className="main">
      <AnimatePresence>
      {ridePopup  && (
        ...
        <div className="main">
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <button
              ...
              className="w-1/2 py-3 px-5 bg-green-700 font-semibold text-lg text-white rounded-lg cursor-pointer hover:opacity-85"
            >
              Accept
            </button>
            <button
