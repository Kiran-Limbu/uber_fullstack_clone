...
router.post('/register', [
    ...
    captainController.registerCpatain
);
...
router.get('/profile', isLoggedIn.authCaptain , captainController.getCaptainProfile )

router.get('/logout', isLoggedIn.authCaptain , captainController.logoutCaptain )
